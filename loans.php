		...
		<div class="card">
			<div class="card-header">
				<div class="card-title">
					...
					<button class="btn btn-primary col-md-2 float-right" type="button" id="add_application"><i class="fa fa-plus"></i>Add New Application</button>
				</div>
				...
				<table class="table table-bordered" id="loan-list">
					...
					<tbody>
						<?php
							...
							$i=1;
							$plan = $conn->query("SELECT *,concat(loan_plan,' [ ',interest_percentage,'%, ',penalty_rate,' ]') as plan FROM loan_plan where id in (SELECT plan_id from loan_list) ");
						 ...
						 <tr>
						 	...
						 	<td>
						 		...
						 		<p><small>Amount borrowed :<b><?php echo $row['amount'] ?></small></b></p>
						 		<p><small>Total Payable Amount :<b><?php echo number_format($monthly,2) ?></small></b></p>
						 		<p><small>Remaining Payable Amount :<b><?php echo $row['total'] ?></small></b></p>
