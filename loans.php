...
<div class="container-fluid">
	<div class="col-lg-12">
		<div class="card">
			...
			<div class="card-body">
				<table class="table table-bordered" id="loan-list borrower-list">
					<colgroup>
						<col width="10%">
						<col width="25%">
						<col width="25%">
						...
						<?php
						 ...
						 <tr>
						 	...
						 	<td>
						 		...
						 		<p><small>Total Payable Amount :<b><?php echo number_format($monthly * $row['plan_id'],2) ?></small></b></p>
...
<script>
	$('#loan-list borrower-list').dataTable()
	$('#borrower-list')
