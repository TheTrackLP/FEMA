...
$fees = $conn->query("SELECT l.*,concat(b.lastname,', ',b.firstname,' ',b.middlename)as name, b.contact_no, b.address from loan_list l inner join borrowers b on b.id = l.borrower_id inner join loan_plan c on c.id = l.plan_id  where l.id = {$_GET['loan_id']}");
...
<div class="container-fluid">
	...
	<div class="flex">
		...
		<?php if($_GET['id'] > 0): ?>
		<div class="w-50">
			<p>Payment Date: <b><?php echo isset($pay_arr[$_GET['id']]) ? date("M d,Y",strtotime($pay_arr[$_GET['id']]['date_created'])). ' - '. date("M d,Y",strtotime($pay_arr[$_GET['id']]['date_created']. '+ 15 days')): '' ?></b></p>
			<p>Paid Amount: <b><?php echo isset($pay_arr[$_GET['id']]) ? number_format($pay_arr[$_GET['id']]['amount'],2): '' ?></b></p>
