...
<?php 
    ...
    if(isset($_POST['submit'])){
        ...
        //}
        //else{
        	$query=mysqli_query($conn, "INSERT INTO loan_list (`ref_no`, `borrower_id`, `purpose`, `shared_cap`, `amount`, `amount_borrowed`, `plan_id`, `status`, `date_released`, `date_created`) VALUES ('$random', '$id', '$purpose', '$shared_capital', '$amount', '$amount', '$plan', '0', '0000-00-00 00:00:00', current_timestamp())");
        	if ($query) {
