				...
				<table class="table table-bordered" id="filterTable">
					...
					<tbody>
						<?php
							...
							$qry = $conn->query("SELECT l.*,concat(b.lastname,', ',b.firstname,' ',b.middlename)as name, b.contact_no, b.address from loan_list l inner join borrowers b on b.id = l.borrower_id where l.status = 3");
